...
- Response của hook luôn là `JSONResponse` trả trực tiếp, để `ResponseMiddleware` bỏ qua ở [response_middleware.py:42](../../../backend/common/core/response_middleware.py#L42) — không bọc envelope `{code,data,msg}`.
